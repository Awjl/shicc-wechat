<template>
  <div class="purchaseDetalis">
    ...
    <div class="line"></div>
    <div class="Detalis">
      <div class="notes">购买须知</div>
      <div class="Detalis-line"></div>
      <div class="he10"></div>
      <div class="he10"></div>
      <div class="Detalislist">有效期：</div>
      <div class="DetalisItem">{{dataList.termOfValidity}}</div>
      <div class="he10"></div>
      <div class="Detalislist">使用时间：</div>
      <div class="DetalisItem">{{dataList.useTime}}</div>
      <div class="he10"></div>
      <div class="Detalislist">使用规则：</div>
      <div class="DetalisItem">
        <p v-for="(item, index) in dataList.useRule" :key="index">{{item}}</p>
      </div>
      <div class="he30"></div>
      <div class="notes">产品详情</div>
      <div class="Detalis-line"></div>
    </div>
    <div class="text-title">{{dataList.name}}</div>
    <div class="text-center" v-html="dataList.introduce"></div>
    <div class="text-img">
    ...
    <div class="footer">
      <div class="footer-left">
        <span class="new">¥
          <span>{{dataList.newPrice | formatFee}}</span>
        </span>
        <span class="old">¥{{dataList.oldPrice | formatFee}}</span>
      </div>
      <div class="footer-over" @click="goSubmission(dataList.goodsId)">立即购买</div>
    </div>
  </div>
</template>
